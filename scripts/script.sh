...
python synth.py $src_dir "english" "printed" $ds_path --iden "sens" --num_samples $batch_sample --scene True --exclude_punct True
...
python synth.py $src_dir "english" "printed" $ds_path --iden "sen" --num_samples $batch_sample --scene False --exclude_punct True
